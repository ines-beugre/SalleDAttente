...
public class TestPrioInteractif
{


	private static SalleDAttenteAvecPrio<Article> file ;
	private static LinkedList<Article> listeArticles ;
	...
	public static void main(String[] args) {
		try{
		    ...
		    file = new SalleDAttenteAvecPrio<Article>(taille, prio) ;
	...
	private static void modifierStock() throws IOException
	{
		...
		else
		{
			...
			Article art = listeArticles.get(i) ;
			if (delta < 0)
			{
				art.retirer(-delta) ;
			}
